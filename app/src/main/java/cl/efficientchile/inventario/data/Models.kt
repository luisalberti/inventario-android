...
data class TokenResp(
    ...
    val rol: String,
    // Lo que informa el servidor al entrar. Todos con valor por defecto: una
    // app nueva contra un servidor viejo no debe caerse por un campo que
    // todavia no existe.
    val licencia: String = "activo",
    @Json(name = "licencia_aviso") val licenciaAviso: String = "",
    val plan: String = "estandar",
    @Json(name = "perm_app") val permApp: Boolean = true,
)
